...
namespace Nas.Services.Tests.Seo
{
    [TestFixture]
    public class SeoExtensionsTests
    {
        ...
        {
            SeoExtensions.GetSeName("abcdefghijklmNasqrstuvwxyz1234567890", false, false).ShouldEqual("abcdefghijklmNasqrstuvwxyz1234567890");
        }
