...
namespace Nas.Data.Tests
{
    ...
    {
        protected NasObjectContext context;
        ...
        {
            string testDbName = "Data Source=" + (System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location)) + @"\\Nas.Data.Tests.Db.sdf;Persist Security Info=False";
            return testDbName;
        }        
