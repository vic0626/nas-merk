...
namespace Nas.Plugin.Widgets.NivoSlider.Models
{
    public class ConfigurationModel : BaseNasModel
    {
        ...
        [NasResourceDisplayName("Plugins.Widgets.NivoSlider.Picture")]
        [UIHint("Picture")]
        public int Picture1Id { get; set; }
        public bool Picture1Id_OverrideForStore { get; set; }
        [NasResourceDisplayName("Plugins.Widgets.NivoSlider.Text")]
        [AllowHtml]
        public string Text1 { get; set; }
        public bool Text1_OverrideForStore { get; set; }
        [NasResourceDisplayName("Plugins.Widgets.NivoSlider.Link")]
        [AllowHtml]
