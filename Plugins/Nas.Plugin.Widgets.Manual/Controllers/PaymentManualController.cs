...
using Nas.Plugin.Payments.Manual.Models;
using Nas.Plugin.Payments.Manual.Validators;
...
namespace Nas.Plugin.Payments.Manual.Controllers
{
    public class PaymentManualController : BaseNasPaymentController
    {
        ...
        public ActionResult PaymentInfo()
        {
            ...
            return View("Nas.Plugin.Payments.Manual.Views.PaymentManual.PaymentInfo", model);
        }
