...
using Nas.Plugin.Shipping.FixedRateShipping.Models;
...
namespace Nas.Plugin.Shipping.FixedRateShipping.Controllers
{
    [AdminAuthorize]
    public class ShippingFixedRateController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("Nas.Plugin.Shipping.FixedRateShipping.Views.ShippingFixedRate.Configure", gridModel);
        }
