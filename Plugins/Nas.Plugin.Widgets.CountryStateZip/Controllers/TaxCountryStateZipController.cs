...
using Nas.Plugin.Tax.CountryStateZip.Models;
...
namespace Nas.Plugin.Tax.CountryStateZip.Controllers
{
    [AdminAuthorize]
    public class TaxCountryStateZipController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("Nas.Plugin.Tax.CountryStateZip.Views.TaxCountryStateZip.Configure", model);
        }
