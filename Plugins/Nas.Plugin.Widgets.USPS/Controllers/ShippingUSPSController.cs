...
using Nas.Plugin.Shipping.USPS.Models;
using Nas.Services.Configuration;
using Nas.Web.Framework.Controllers;

namespace Nas.Plugin.Shipping.USPS.Controllers
{
    [AdminAuthorize]
    public class ShippingUSPSController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("Nas.Plugin.Shipping.USPS.Views.ShippingUSPS.Configure", model);
        }
