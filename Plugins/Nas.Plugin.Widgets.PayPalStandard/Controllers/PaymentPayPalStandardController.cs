...
using Nas.Plugin.Payments.PayPalStandard.Models;
...
namespace Nas.Plugin.Payments.PayPalStandard.Controllers
{
    public class PaymentPayPalStandardController : BaseNasPaymentController
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("Nas.Plugin.Payments.PayPalStandard.Views.PaymentPayPalStandard.Configure", model);
        }
        ...
        {
            return View("Nas.Plugin.Payments.PayPalStandard.Views.PaymentPayPalStandard.PaymentInfo");
        }
