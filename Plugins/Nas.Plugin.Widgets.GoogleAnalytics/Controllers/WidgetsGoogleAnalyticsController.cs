...
using Nas.Plugin.Widgets.GoogleAnalytics.Models;
...
namespace Nas.Plugin.Widgets.GoogleAnalytics.Controllers
{
    public class WidgetsGoogleAnalyticsController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("Nas.Plugin.Widgets.GoogleAnalytics.Views.WidgetsGoogleAnalytics.Configure", model);
        }
        ...
        public ActionResult PublicInfo(string widgetZone)
        {
            ...
            //return View("Nas.Plugin.Widgets.GoogleAnalytics.Views.WidgetsGoogleAnalytics.PublicInfo", model);
        }
