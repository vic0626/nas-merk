...
using Nas.Plugin.DiscountRules.HadSpentAmount.Models;
...
namespace Nas.Plugin.DiscountRules.HadSpentAmount.Controllers
{
    [AdminAuthorize]
    public class DiscountRulesHadSpentAmountController : Controller
    {
        ...
        public ActionResult Configure(int discountId, int? discountRequirementId)
        {
            ...
            return View("Nas.Plugin.DiscountRules.HadSpentAmount.Views.DiscountRulesHadSpentAmount.Configure", model);
        }
