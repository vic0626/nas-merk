...
using Nas.Plugin.DiscountRules.CustomerRoles.Models;
...
namespace Nas.Plugin.DiscountRules.CustomerRoles.Controllers
{
    [AdminAuthorize]
    public class DiscountRulesCustomerRolesController : Controller
    {
        ...
        public ActionResult Configure(int discountId, int? discountRequirementId)
        {
            ...
            return View("Nas.Plugin.DiscountRules.CustomerRoles.Views.DiscountRulesCustomerRoles.Configure", model);
        }
