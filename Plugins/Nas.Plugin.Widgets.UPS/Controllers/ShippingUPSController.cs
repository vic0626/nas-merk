...
namespace Nas.Plugin.Shipping.UPS.Controllers
{
    ...
    public class ShippingUPSController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("Nas.Plugin.Shipping.UPS.Views.ShippingUPS.Configure", model);
        }
