...
using Nas.Plugin.Shipping.Fedex.Domain;
using Nas.Plugin.Shipping.Fedex.RateServiceWebReference;
...
using Nas.Services.Shipping.Tracking;

namespace Nas.Plugin.Shipping.Fedex
{
    /// <summary>
    ...
    public class FedexComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        private RateRequest CreateRateRequest(GetShippingOptionRequest getShippingOptionRequest, out Currency requestedShipmentCurrency)
        {
            ...
            request.TransactionDetail.CustomerTransactionId = "***Rate Available Services v7 Request - NasCommerce***"; // This is a reference field for the customer.  Any value can be used and will be provided in the response.
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (IsPackageTooLarge(dimension, dimension, dimension))
                        throw new NasException("fedexSettings.PackingPackageVolume exceeds max package size");
        ...
        private MeasureWeight GetUsedMeasureWeight()
        {
            ...
            if (usedMeasureWeight == null)
                throw new NasException("FedEx shipping service. Could not load \"{0}\" measure weight", MEASUREWEIGHTSYSTEMKEYWORD);
        ...
        private MeasureDimension GetUsedMeasureDimension()
        {
            ...
            if (usedMeasureDimension == null)
                throw new NasException("FedEx shipping service. Could not load \"{0}\" measure dimension", MEASUREDIMENSIONSYSTEMKEYWORD);
        ...
        private Currency GetRequestedShipmentCurrency(string originCountryCode, string destinCountryCode)
        {
            ...
            //because NasCommerce does not have a concept of a designated currency for a Country.
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "Nas.Plugin.Shipping.Fedex.Controllers" }, { "area", null } };
        }
        ...
        public override void Install()
        {
            ...
            var settings = new FedexSettings()
            {
                ...
                DropoffType = Nas.Plugin.Shipping.Fedex.DropoffType.BusinessServiceCenter,
            ...
            this.AddOrUpdatePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.PackingType.PackByDimensions", "Pack by dimensions");
            this.AddOrUpdatePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.PackingType.PackByOneItemPerPackage", "Pack by one item per package");
            this.AddOrUpdatePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.PackingType.PackByVolume", "Pack by volume");
            ...
            this.AddOrUpdatePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.DropoffType.BusinessServiceCenter", "Business service center");
            this.AddOrUpdatePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.DropoffType.DropBox", "Drop box");
            this.AddOrUpdatePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.DropoffType.RegularPickup", "Regular pickup");
            this.AddOrUpdatePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.DropoffType.RequestCourier", "Request courier");
            this.AddOrUpdatePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.DropoffType.Station", "Station");
        ...
        public override void Uninstall()
        {
            ...
            this.DeletePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.PackingType.PackByDimensions");
            this.DeletePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.PackingType.PackByOneItemPerPackage");
            this.DeletePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.PackingType.PackByVolume");
            ...
            this.DeletePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.DropoffType.BusinessServiceCenter");
            this.DeletePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.DropoffType.DropBox");
            this.DeletePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.DropoffType.RegularPickup");
            this.DeletePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.DropoffType.RequestCourier");
            this.DeletePluginLocaleResource("Enums.Nas.Plugin.Shipping.Fedex.DropoffType.Station");
