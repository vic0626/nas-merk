...
using Nas.Plugin.Shipping.Fedex.Models;
using Nas.Services.Configuration;
using Nas.Web.Framework;
using Nas.Web.Framework.Controllers;

namespace Nas.Plugin.Shipping.Fedex.Controllers
{
    [AdminAuthorize]
    public class ShippingFedexController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("Nas.Plugin.Shipping.Fedex.Views.ShippingFedex.Configure", model);
        }
