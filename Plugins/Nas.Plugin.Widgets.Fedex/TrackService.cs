...
public partial class TrackService : System.Web.Services.Protocols.SoapHttpClientProtocol
{
    ...
    private System.Threading.SendOrPostCallback getTrackNotificatioNaserationCompleted;
    ...
    {
        if ((this.getTrackNotificatioNaserationCompleted == null))
        {
            this.getTrackNotificatioNaserationCompleted = new System.Threading.SendOrPostCallback(this.OngetTrackNotificatioNaserationCompleted);
        }
        this.InvokeAsync("getTrackNotification", new object[] {
                    TrackNotificationRequest}, this.getTrackNotificatioNaserationCompleted, userState);
    }

    private void OngetTrackNotificatioNaserationCompleted(object arg)
    {
