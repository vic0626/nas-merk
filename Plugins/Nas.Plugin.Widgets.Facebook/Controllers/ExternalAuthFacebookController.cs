...
using Nas.Plugin.ExternalAuth.Facebook.Models;
...
namespace Nas.Plugin.ExternalAuth.Facebook.Controllers
{
    public class ExternalAuthFacebookController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("Nas.Plugin.ExternalAuth.Facebook.Views.ExternalAuthFacebook.Configure", model);
        }
        ...
        {
            return View("Nas.Plugin.ExternalAuth.Facebook.Views.ExternalAuthFacebook.PublicInfo");
        }
        ...
        private ActionResult LoginInternal(string returnUrl, bool verifyResponse)
        {
            ...
            if (processor == null ||
                ...
                throw new NasException("Facebook module cannot be loaded");
