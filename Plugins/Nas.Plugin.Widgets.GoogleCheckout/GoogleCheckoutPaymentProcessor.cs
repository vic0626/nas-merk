...
using Nas.Plugin.Payments.GoogleCheckout.Controllers;
...
namespace Nas.Plugin.Payments.GoogleCheckout
{
    ...
    public class GoogleCheckoutPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public decimal GetAdditionalHandlingFee(IList<Nas.Core.Domain.Orders.ShoppingCartItem> cart)
        {
            return decimal.Zero;
        }
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "Nas.Plugin.Payments.GoogleCheckout.Controllers" }, { "area", null } };
        }
