...
using Nas.Plugin.Payments.AuthorizeNet.Models;
using Nas.Plugin.Payments.AuthorizeNet.Validators;
...
namespace Nas.Plugin.Payments.AuthorizeNet.Controllers
{
    public class PaymentAuthorizeNetController : BaseNasPaymentController
    {
        ...
        public ActionResult PaymentInfo()
        {
            ...
            return View("Nas.Plugin.Payments.AuthorizeNet.Views.PaymentAuthorizeNet.PaymentInfo", model);
        }
