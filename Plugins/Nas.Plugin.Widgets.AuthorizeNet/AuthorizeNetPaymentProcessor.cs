...
using Nas.Plugin.Payments.AuthorizeNet.Controllers;
using Nas.Plugin.Payments.AuthorizeNet.net.authorize.api;
...
namespace Nas.Plugin.Payments.AuthorizeNet
{
    /// <summary>
    ...
    public class AuthorizeNetPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "Nas.Plugin.Payments.AuthorizeNet.Controllers" }, { "area", null } };
        }
