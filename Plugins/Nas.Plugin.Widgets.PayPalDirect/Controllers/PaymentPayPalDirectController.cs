...
using Nas.Plugin.Payments.PayPalDirect.Models;
using Nas.Plugin.Payments.PayPalDirect.Validators;
...
namespace Nas.Plugin.Payments.PayPalDirect.Controllers
{
    public class PaymentPayPalDirectController : BaseNasPaymentController
    {
        ...
        public ActionResult PaymentInfo()
        {
            ...
            return View("Nas.Plugin.Payments.PayPalDirect.Views.PaymentPayPalDirect.PaymentInfo", model);
        }
        ...
        public ActionResult IPNHandler()
        {
            ...
            if (processor == null ||
                ...
                throw new NasException("PayPal Direct module cannot be loaded");
