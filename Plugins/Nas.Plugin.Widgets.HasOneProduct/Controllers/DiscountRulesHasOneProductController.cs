...
using Nas.Plugin.DiscountRules.HasOneProduct.Models;
...
namespace Nas.Plugin.DiscountRules.HasOneProduct.Controllers
{
    [AdminAuthorize]
    public class DiscountRulesHasOneProductController : Controller
    {
        ...
        public ActionResult Configure(int discountId, int? discountRequirementId)
        {
            ...
            return View("Nas.Plugin.DiscountRules.HasOneProduct.Views.DiscountRulesHasOneProduct.Configure", model);
        }
