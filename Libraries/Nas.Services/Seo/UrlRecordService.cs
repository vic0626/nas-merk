...
namespace Nas.Services.Seo
{
    ...
    public partial class UrlRecordService : IUrlRecordService
    {
        ...
        /// {2} : language ID
        /// </remarks>
        private const string URLRECORD_ACTIVE_BY_ID_NAME_LANGUAGE_KEY = "Nas.urlrecord.active.id-name-language-{0}-{1}-{2}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string URLRECORD_PATTERN_KEY = "Nas.urlrecord.";
