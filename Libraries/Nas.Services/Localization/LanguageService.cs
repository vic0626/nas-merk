...
namespace Nas.Services.Localization
{
    ...
    public partial class LanguageService : ILanguageService
    {
        ...
        /// {0} : language ID
        /// </remarks>
        private const string LANGUAGES_BY_ID_KEY = "Nas.language.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// {1} : store ID
        /// </remarks>
        private const string LANGUAGES_ALL_KEY = "Nas.language.all-{0}-{1}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string LANGUAGES_PATTERN_KEY = "Nas.language.";
