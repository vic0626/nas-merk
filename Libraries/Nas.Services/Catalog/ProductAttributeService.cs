...
namespace Nas.Services.Catalog
{
    /// <summary>
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string PRODUCTATTRIBUTES_ALL_KEY = "Nas.productattribute.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string PRODUCTATTRIBUTES_BY_ID_KEY = "Nas.productattribute.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string PRODUCTVARIANTATTRIBUTES_ALL_KEY = "Nas.productvariantattribute.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string PRODUCTVARIANTATTRIBUTES_BY_ID_KEY = "Nas.productvariantattribute.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : product variant attribute ID
        /// </remarks>
        private const string PRODUCTVARIANTATTRIBUTEVALUES_ALL_KEY = "Nas.productvariantattributevalue.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string PRODUCTVARIANTATTRIBUTEVALUES_BY_ID_KEY = "Nas.productvariantattributevalue.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PRODUCTATTRIBUTES_PATTERN_KEY = "Nas.productattribute.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PRODUCTVARIANTATTRIBUTES_PATTERN_KEY = "Nas.productvariantattribute.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PRODUCTVARIANTATTRIBUTEVALUES_PATTERN_KEY = "Nas.productvariantattributevalue.";
        #endregion
