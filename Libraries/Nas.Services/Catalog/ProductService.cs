...
namespace Nas.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        /// {0} : product ID
        /// </remarks>
        private const string PRODUCTS_BY_ID_KEY = "Nas.product.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string PRODUCTVARIANTS_ALL_KEY = "Nas.productvariant.all-{0}-{1}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string PRODUCTVARIANTS_BY_ID_KEY = "Nas.productvariant.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PRODUCTS_PATTERN_KEY = "Nas.product.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PRODUCTVARIANTS_PATTERN_KEY = "Nas.productvariant.";
        #endregion
