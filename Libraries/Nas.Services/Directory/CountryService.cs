...
namespace Nas.Services.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        /// </remarks>
        private const string COUNTRIES_ALL_KEY = "Nas.country.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : show hidden records?
        /// </remarks>
        private const string COUNTRIES_BILLING_KEY = "Nas.country.billing-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : show hidden records?
        /// </remarks>
        private const string COUNTRIES_SHIPPING_KEY = "Nas.country.shipping-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string COUNTRIES_PATTERN_KEY = "Nas.country.";
