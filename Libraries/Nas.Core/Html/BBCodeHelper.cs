...
using Nas.Core.Html.CodeFormatter;

namespace Nas.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote)
        {
            ...
            if (replaceUrl)
            {
                // format the url tags: [url=http://www.NasCommerce.com]my site[/url]
                // becomes: <a href="http://www.NasCommerce.com">my site</a>
                text = regexUrl1.Replace(text, "<a href=\"$1\" rel=\"nofollow\">$2</a>");

                // format the url tags: [url]http://www.NasCommerce.com[/url]
                // becomes: <a href="http://www.NasCommerce.com">http://www.NasCommerce.com</a>
