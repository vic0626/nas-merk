...
{
    /// <summary>
    /// A class that finds types needed by Nas by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether Nas should iterate assemblies in the app domain when loading Nas types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Nas assemblies arn't investigated (e.g. by not including something like "^Nas|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the Nas factory.</returns>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Nas.
        /// </returns>
