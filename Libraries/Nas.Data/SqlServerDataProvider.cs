...
namespace Nas.Data
{
    public class SqlServerDataProvider : BaseEfDataProvider
    {
        ...
        {
            //pass some table names to ensure that we have NasCommerce 2.X installed
            ...
            var initializer = new CreateTablesIfNotExist<NasObjectContext>(tablesToValidate, customCommands.ToArray());
