...
namespace Nas.Web.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeleted<StateProvince>>
    {
        ...
        /// {3} : current store ID
        /// </remarks>
        public const string MANUFACTURER_NAVIGATION_MODEL_KEY = "Nas.pres.manufacturer.navigation-{0}-{1}-{2}-{3}";
        public const string MANUFACTURER_NAVIGATION_PATTERN_KEY = "Nas.pres.manufacturer.navigation";
        ...
        /// </remarks>
        public const string CATEGORY_NAVIGATION_MODEL_KEY = "Nas.pres.category.navigation-{0}-{1}-{2}-{3}";
        public const string CATEGORY_NAVIGATION_PATTERN_KEY = "Nas.pres.category.navigation";
        ...
        /// {3} : current store ID
        /// </remarks>
        public const string CATEGORY_CHILD_IDENTIFIERS_MODEL_KEY = "Nas.pres.category.childidentifiers-{0}-{1}-{2}-{3}";
        public const string CATEGORY_CHILD_IDENTIFIERS_PATTERN_KEY = "Nas.pres.category.childidentifiers";
        ...
        /// {3} : current store ID
        /// </remarks>
        public const string PRODUCT_BREADCRUMB_MODEL_KEY = "Nas.pres.product.breadcrumb-{0}-{1}-{2}-{3}";
        public const string PRODUCT_BREADCRUMB_PATTERN_KEY = "Nas.pres.product.breadcrumb";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string PRODUCTTAG_BY_PRODUCT_MODEL_KEY = "Nas.pres.producttag.byproduct-{0}-{1}-{2}";
        public const string PRODUCTTAG_BY_PRODUCT_PATTERN_KEY = "Nas.pres.producttag.byproduct";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string PRODUCTTAG_POPULAR_MODEL_KEY = "Nas.pres.producttag.popular-{0}-{1}";
        public const string PRODUCTTAG_POPULAR_PATTERN_KEY = "Nas.pres.producttag.popular";
        ...
        /// {3} : current store ID
        /// </remarks>
        public const string PRODUCT_MANUFACTURERS_MODEL_KEY = "Nas.pres.product.manufacturers-{0}-{1}-{2}-{3}";
        public const string PRODUCT_MANUFACTURERS_PATTERN_KEY = "Nas.pres.product.manufacturers";
        ...
        /// {1} : language id
        /// </remarks>
        public const string PRODUCT_SPECS_MODEL_KEY = "Nas.pres.product.specs-{0}-{1}";
        public const string PRODUCT_SPECS_PATTERN_KEY = "Nas.pres.product.specs";
        ...
        /// {2} : store id
        /// </remarks>
        public const string TOPIC_MODEL_KEY = "Nas.pres.topic.details-{0}-{1}-{2}";
        public const string TOPIC_PATTERN_KEY = "Nas.pres.topic.details";
        ...
        /// </remarks>
        public const string CATEGORY_TEMPLATE_MODEL_KEY = "Nas.pres.categorytemplate-{0}";
        public const string CATEGORY_TEMPLATE_PATTERN_KEY = "Nas.pres.categorytemplate";
        ...
        /// </remarks>
        public const string MANUFACTURER_TEMPLATE_MODEL_KEY = "Nas.pres.manufacturertemplate-{0}";
        public const string MANUFACTURER_TEMPLATE_PATTERN_KEY = "Nas.pres.manufacturertemplate";
        ...
        /// </remarks>
        public const string PRODUCT_TEMPLATE_MODEL_KEY = "Nas.pres.producttemplate-{0}";
        public const string PRODUCT_TEMPLATE_PATTERN_KEY = "Nas.pres.producttemplate";
        ...
        /// {0} : current store ID
        /// </remarks>
        public const string HOMEPAGE_BESTSELLERS_IDS_KEY = "Nas.pres.bestsellers.homepage-{0}";
        public const string HOMEPAGE_BESTSELLERS_IDS_PATTERN_KEY = "Nas.pres.bestsellers.homepage";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string PRODUCTS_ALSO_PURCHASED_IDS_KEY = "Nas.pres.alsopuchased-{0}-{1}";
        public const string PRODUCTS_ALSO_PURCHASED_IDS_PATTERN_KEY = "Nas.pres.alsopuchased";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string PRODUCT_DEFAULTPICTURE_MODEL_KEY = "Nas.pres.product.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string PRODUCT_DEFAULTPICTURE_PATTERN_KEY = "Nas.pres.product.picture";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string CATEGORY_PICTURE_MODEL_KEY = "Nas.pres.category.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string CATEGORY_PICTURE_PATTERN_KEY = "Nas.pres.category.picture";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string MANUFACTURER_PICTURE_MODEL_KEY = "Nas.pres.manufacturer.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string MANUFACTURER_PICTURE_PATTERN_KEY = "Nas.pres.manufacturer.picture";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string CART_PICTURE_MODEL_KEY = "Nas.pres.cart.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string CART_PICTURE_PATTERN_KEY = "Nas.pres.cart.picture";
        ...
        /// {0} : language ID
        /// </remarks>
        public const string HOMEPAGE_POLLS_MODEL_KEY = "Nas.pres.poll.homepage-{0}";
        /// <summary>
        ...
        /// {1} : language ID
        /// </remarks>
        public const string POLL_BY_SYSTEMNAME__MODEL_KEY = "Nas.pres.poll.systemname-{0}-{1}";
        public const string POLLS_PATTERN_KEY = "Nas.pres.poll.";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string BLOG_TAGS_MODEL_KEY = "Nas.pres.blog.tags-{0}-{1}";
        /// <summary>
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string BLOG_MONTHS_MODEL_KEY = "Nas.pres.blog.months-{0}-{1}";
        public const string BLOG_PATTERN_KEY = "Nas.pres.blog.";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string HOMEPAGE_NEWSMODEL_KEY = "Nas.pres.news.homepage-{0}-{1}";
        public const string NEWS_PATTERN_KEY = "Nas.pres.news.";
        ...
        /// {0} : language ID
        /// </remarks>
        public const string STATEPROVINCES_BY_COUNTRY_MODEL_KEY = "Nas.pres.stateprovinces.bycountry-{0}-{1}-{2}";
        public const string STATEPROVINCES_PATTERN_KEY = "Nas.pres.stateprovinces.";
        ...
        /// {0} : current store ID
        /// </remarks>
        public const string AVAILABLE_LANGUAGES_MODEL_KEY = "Nas.pres.languages.all-{0}";
        public const string AVAILABLE_LANGUAGES_PATTERN_KEY = "Nas.pres.languages.";
        ...
        /// {0} : current store ID
        /// </remarks>
        public const string AVAILABLE_CURRENCIES_MODEL_KEY = "Nas.pres.currencies.all-{0}-{1}";
        public const string AVAILABLE_CURRENCIES_PATTERN_KEY = "Nas.pres.currencies.";
        ...
        public ModelCacheEventConsumer()
        {
            ...
            this._cacheManager = EngineContext.Current.ContainerManager.Resolve<ICacheManager>("Nas_cache_static");
        }
