...
namespace Nas.Web.Models.ShoppingCart
{
    public partial class ShoppingCartModel : BaseNasModel
    {
        ...
        public partial class CheckoutAttributeModel : BaseNasEntityModel
        {
        ...
        public partial class CheckoutAttributeValueModel : BaseNasEntityModel
        {
            public string Name { get; set; }
        ...
        public partial class DiscountBoxModel: BaseNasModel
        {
        ...
        public partial class GiftCardBoxModel : BaseNasModel
        {
            public bool Display { get; set; }
            public string Message { get; set; }
        }

        public partial class OrderReviewDataModel : BaseNasModel
        {
