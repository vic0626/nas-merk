...
using Nas.Web.Infrastructure.Cache;
using Nas.Web.Models.News;

namespace Nas.Web.Controllers
{
    [NasHttpsRequirement(SslRequirement.No)]
    public partial class NewsController : BaseNasController
    {
		#region Fields
        ...
        public ActionResult NewsCommentAdd(int newsItemId, NewsItemModel model, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["Nas.news.addcomment.result"] = _localizationService.GetResource("News.Comments.SuccessfullyAdded");
