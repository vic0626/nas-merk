...
namespace Nas.Web.Controllers
{
    ...
    public partial class BoardsController : BaseNasController
    {
        #region Fields
            ...
            string within, string limitDays, int page = 1)
        {
            ...
            try
            {
                if (String.IsNullOrWhiteSpace(searchterms) == false)
                {
                    ...
                    {
                        throw new NasException(string.Format(_localizationService.GetResource("Forum.SearchTermMinimumLengthIsNCharacters"),
