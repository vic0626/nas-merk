...
{
    [AdminAuthorize]
    public partial class CurrencyController :  BaseNasController
    {
        #region Fields
        ...
        public ActionResult Delete(int id)
        {
            ...
            try
            {
                if (currency.Id == _currencySettings.PrimaryStoreCurrencyId)
                    throw new NasException(_localizationService.GetResource("Admin.Configuration.Currencies.CantDeletePrimary"));

                if (currency.Id == _currencySettings.PrimaryExchangeRateCurrencyId)
                    throw new NasException(_localizationService.GetResource("Admin.Configuration.Currencies.CantDeleteExchange"));
