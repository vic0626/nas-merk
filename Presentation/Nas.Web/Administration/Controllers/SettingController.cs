...
using Nas.Web.Framework.UI.Captcha;
using Telerik.Web.Mvc;

namespace Nas.Admin.Controllers
{
	[AdminAuthorize]
    public partial class SettingController : BaseNasController
	{
		#region Fields
        ...
        public ActionResult ChangeEncryptionKey(GeneralCommonSettingsModel model)
        {
            ...
            try
            {
                ...
                if (String.IsNullOrEmpty(newEncryptionPrivateKey) || newEncryptionPrivateKey.Length != 16)
                    throw new NasException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.EncryptionKey.TooShort"));

                string oldEncryptionPrivateKey = securitySettings.EncryptionKey;
                if (oldEncryptionPrivateKey == newEncryptionPrivateKey)
                    throw new NasException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.EncryptionKey.TheSame"));
        ...
        public ActionResult ToggleFullText(GeneralCommonSettingsModel model)
        {
            ...
            try
            {
                if (! _fulltextService.IsFullTextSupported())
                    throw new NasException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.FullTextSettings.NotSupported"));
